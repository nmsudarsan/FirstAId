...
def text_to_speech_with_elevenlabs(input_text, output_filepath_mp3):
    ...
    # Step 1: Generate MP3 with ElevenLabs
    audio = client.generate(
        text=input_text,
        voice="Aria",
        output_format="mp3_22050_32",
    ...
    subprocess.run(["ffmpeg", "-y", "-i", output_filepath_mp3, output_filepath_wav])

    return output_filepath_wav  # Return WAV file path for playback
